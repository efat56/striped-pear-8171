...
public class OrderController {
	...
	public ResponseEntity<Orders> viewOrder(@PathVariable("id") Integer id) throws OrderException{
	...
	public ResponseEntity<List<Orders>> viewAllOrder(@PathVariable("date") LocalDate date) throws OrderException{
	...
	public ResponseEntity<List<Orders>> viewAllOrders(@PathVariable("id") Integer userId) throws OrderException, AddressException{
